    ...
    <div class="rules__container">
      <div class="rules__body">
        ...
        <div class="main-rules">
          <h1 class="main-rules__title">Правила игры</h1>
          <p class="main-rules__description">Могли бы вы себе представить как это пережить глобальную катастрофу?
                                             Думаю
          ...
          <div class="main-rules__body">
            <ul class="main-rules__mainList">
              ...
              <li id="review">
                ...
                <ul>
                  <li>
                    <router-link to="/">Пол</router-link>
                  </li>
                  <li>
                    <router-link to="/">Телосложение</router-link>
                  </li>
                  <li>
                    <router-link to="/">Человеческая черта</router-link>
                  </li>
                  <li>
                    <router-link to="/">Специальность</router-link>
                  </li>
                  <li>
                  ...
                  <li>
                    <router-link to="/">Спец. возможность #2</router-link>
                  </li>
                </ul>
                <router-link to="/">(см. Характеристики персонажа)</router-link>
                <h3>Видео чат</h3>
                ...
                <div class="table">
                  <div class="table__body">
                    <div class="table__row">
                      <div class="table__column">Количество игроков</div>
                      <div class="table__column">Могут попасть в бункер</div>
                      <div class="table__column">Характеристик в первый раунд (исключая специальность)</div>
                    </div>
                    <div class="table__row">
                      <div class="table__column">6-7</div>
                      <div class="table__column">3</div>
                      <div class="table__column">3</div>
                    </div>
                    <div class="table__row">
                      <div class="table__column">8-9</div>
                      <div class="table__column">4</div>
                      <div class="table__column">3</div>
                    </div>
                    <div class="table__row">
                      <div class="table__column">10-11</div>
                      <div class="table__column">5</div>
                      <div class="table__column">2</div>
                    </div>
                    <div class="table__row">
                      <div class="table__column">12-13</div>
                      <div class="table__column">6</div>
                      <div class="table__column">1</div>
                    </div>
                    <div class="table__row">
                      <div class="table__column">14-15</div>
                      <div class="table__column">7</div>
                      <div class="table__column">1</div>
                    </div>
                  </div>
                </div>
