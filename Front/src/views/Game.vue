    ...
    <div id="welcome" class="welcome">
      ...
      <div class="welcome__container">
        <div class="welcome__body">
          <h1 class="welcome__titleH2 titleH2">
            Катаклизм
          </h1>
    ...
    <div class="voting">
      <div class="voting__container">
        <div class="voting__now now-voting">
          <h2 class="now-voting__title titleH2">Голосование</h2>
        ...
        <div class="voting__result results-voting">
          <h2 class="results-voting__title titleH2">Результат последнего голосования</h2>
